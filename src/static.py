...
MODE_SHIFTLIGHT_LIMITER = 2
MODE_SHIFTLIGHT_REV = 1
MODE_SHIFTLIGHT_OFF = 0
...
KEY_SAMPLE_SL_BRIGHTNESS = f"{KEY_SHIFTLIGHT}_SampleBright"
KEY_SAMPLE_SL_PATTERN = f"{KEY_SHIFTLIGHT}_SamplePattern"
KEY_SAMPLE_SL_COLOR = f"{KEY_SHIFTLIGHT}_SampleColor"
